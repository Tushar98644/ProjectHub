...
import { FaHome, FaChartBar, FaRProject } from "react-icons/fa";
import { FaCircleUser, FaDiagramProject, FaFolder } from "react-icons/fa6";
...
const navItems = [
    ...
    { href: "/project/new", label: "New Project", icon: <FaRProject className="h-6 w-6" /> },
    { href: "/", label: "All Projects", icon: <FaFolder className="h-6 w-6" /> },
    { href: "/dashboard/settings", label: "Settings", icon: <FaCircleUser className="h-6 w-6" /> },
];
