    ...
    return (
        <div>
            ...
            <div className="space-y-4 divide-y divide-slate-700">
                <div>
                    <h3 className="text-lg font-medium text-slate-200 mt-2 mb-1">
                        Email Notifications
                    </h3>
                    ...
                    <ToggleSwitch
                        label="Post Likes"
                        enabled={emailNotifications.postLikes}
                        onChange={() => handleToggle("postLikes")}
                    />
                    <ToggleSwitch
                        label="Comments on your posts"
                        enabled={emailNotifications.comments}
                        onChange={() => handleToggle("comments")}
                    />
                    <ToggleSwitch
                        label="Mentions"
                        enabled={emailNotifications.mentions}
                ...
                <div className="pt-4">
                    ...
                    <ToggleSwitch
                        label="Newsletters"
                        enabled={emailNotifications.newsletters}
