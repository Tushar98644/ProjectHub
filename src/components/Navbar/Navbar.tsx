...
const Navbar = () => {
        ...
        switch (action.type) {
            case "SET_MOBILE_VIEW":
                return {
                    ...
                    isMenuOpen:
                        action.payload === false ? false : state.isMenuOpen,
                };
            case "TOGGLE_MENU":
    ...
    if (pathname === "/login" || state.isMobile === undefined) {
        return (
            <div className="fixed top-0 left-0 w-full h-20 bg-transparent z-50 pointer-events-none"></div>
        );
    }
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                className="h-10 w-auto transition-transform duration-300 group-hover:rotate-[15deg] md:hidden"
                            />
