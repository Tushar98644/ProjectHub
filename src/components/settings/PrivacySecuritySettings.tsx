...
const ToggleSwitch: React.FC<{ label: string; description?: string; enabled: boolean; onChange: (enabled: boolean) => void }> =
...
const PrivacySecuritySettings: React.FC = () => {
    ...
    return (
        <div>
            <h2 className="text-2xl font-semibold text-sky-400 mb-6">Privacy & Security</h2>
            ...
            <div className="mt-8 p-6 bg-slate-700/50 rounded-lg">
                <h3 className="text-lg font-semibold text-slate-100 mb-3">Manage Connected Devices</h3>
                <p className="text-sm text-slate-400 mb-4">
                    Review and revoke access for devices that have logged into your account.
                </p>
                {/* Placeholder for device list */}
                <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-slate-600/70 rounded-md">
                        <div>
                            <p className="font-medium text-slate-200">Chrome on Windows 10</p>
                            <p className="text-xs text-slate-400">Last active: 2 hours ago - New York, USA</p>
                        </div>
                        <button className="text-xs text-red-400 hover:text-red-300 font-semibold">Revoke</button>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-slate-600/70 rounded-md">
                        <div>
                            <p className="font-medium text-slate-200">Safari on iPhone 15 Pro</p>
                            <p className="text-xs text-slate-400">Last active: 1 day ago - London, UK</p>
                        </div>
                        <button className="text-xs text-red-400 hover:text-red-300 font-semibold">Revoke</button>
                    </div>
                </div>
