...
const Navbar = () => {
  return (
    <div className='nav font-bold flex flex-row xl:gap-56 lg:gap-24 p-8 pl-24 fixed min-w-full'>
      <p className='text-3xl text-white font-black animate-pulse'>PROJECT HUB</p>
      <nav className='lg:flex flex-row text-lg text-nav-text gap-16 cursor-pointer hover:transition sm:hidden md:hidden'>
        <ul className='hover:text-white'>Template Pages</ul>
        <ul className='hover:text-white'>Utility Pages</ul>
      </nav>
      <div className='flex flex-row lg:gap-8 xl:gap-10 text-center'>
        <div className='box'>
