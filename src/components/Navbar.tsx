...
const Navbar = () => {
  return (
    <div className='nav font-bold flex flex-row xl:gap-24 lg:gap-12 md:gap-20 p-8 pl-24 fixed min-w-full sm:gap-40'>
      ...
      <nav className='lg:flex flex-row text-lg text-nav-text gap-16 cursor-pointer hover:transition sm:hidden md:flex xsm:hidden'>
        <ul className='hover:text-white'><Link href='/project'>Add project</Link></ul>
        <ul className='hover:text-white'><Link href='/'>View Projects</Link></ul>
        <ul className='hover:text-white'><Link href='/admin'>Admin Panel</Link></ul>
      </nav>
