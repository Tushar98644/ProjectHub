...
const Discussion_page = () => {
    ...
    return (
        <div className="flex h-screen items-center justify-center">
            {!showdiscussion && (
                <div className=" flex flex-col items-center p-12 rounded-xl px-32 bg-green-50 text-slate-800 shadow-sm dark:bg-slate-900 dark:text-slate-400">
                    ...
                    <p className="mt-6 mb-6 max-w-2xl text-center text-slate-800 dark:text-teal-400">
                        Start a new discussion htmlFor this topic with all the
                        community members. Please be fair to others, htmlFor the
                        full rules do refer to the{" "}
            ...
            {showdiscussion && (
                <div className="pt-[30vw] w-screen">
                        ...
                        <div className="max-w-2xl mx-auto px-4 ">
                            ...
                            <article className="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
                                ...
                                <p className="text-gray-500 dark:text-gray-400">
                                    ...
                                    the instruments htmlFor the UX designers.
                                    The knowledge of the design tools are as
                            ...
                            <article className="p-6 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                ...
                                <p className="text-gray-500 dark:text-gray-400">
                                    Thanks htmlFor sharing this. I do came from
                                    the Backend development and explored some of
