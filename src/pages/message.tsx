...
const Message_page = () => {
    ...
    useEffect(() => {
        const getMessages = async () => {
            ...
            await axios.get('/api/message', config)
                .then((res) => {
        ...
        <Layout>
            <div className="flex flex-col md:gap-8 gap-0">
                <div className="font-extrabold text-white text-center pt-40 md:text-5xl text-4xl mx-8">
                    See what <span className="bg-gradient-to-r from-[#4ca5ff] to-[#b673f8] bg-clip-text text-transparent">the users have</span>  to say about us !
                </div>
